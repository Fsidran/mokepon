...
let hipodoge = new Mokepon(
  ...
  "./assets/Hipodoge.png",
  5,
  "./assets/HipodogeC.png"
);
let capipepo = new Mokepon(
  "Capipepo",
  "./assets/Capipepo.png",
  5,
  "./assets/CapipepoC.png"
);
let ratigueya = new Mokepon(
  "Ratigueya",
  "./assets/Ratigueya.png",
  5,
  "./assets/RatigueyaC.png"
);
...
function obtenerAtaques() {
  fetch(`http://192.168.1.2:8080/mokepon/${enemigoId}/ataques`).then(function (
    res
  ) {
    if (res.ok) {
...
//SEQUENCE 12 - renvoi dans le HMTL les attaques utilisées. test
...
function pintarCanvas() {
  mascotaJugadorObjeto.x =
    mascotaJugadorObjeto.x + mascotaJugadorObjeto.velocidadX; //modifie la valeur en x sur le canva de l'objet
  mascotaJugadorObjeto.y =
    mascotaJugadorObjeto.y + mascotaJugadorObjeto.velocidadY; //modifie la valeur en y sur le canva de l'objet
